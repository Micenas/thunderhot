Contributing to thunderhot Core
============================

The thunderhot Core project operates an open contributor model where anyone is
...
The following applies to code changes to the thunderhot Core project, and is not to be
confused with overall thunderhot Network Protocol consensus changes.

Whether a pull request is merged into thunderhot Core rests with the project merge
...
Patches that change thunderhot consensus rules are considerably more involved than
...
Where a patch set proposes to change the thunderhot consensus, it must have been
...
The project leader is the release manager for each thunderhot Core release.
