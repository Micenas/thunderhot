...
/** Utility functions used by the thunderhot Qt UI.
 */
namespace GUIUtil
{
...
// Render thunderhot addresses in monospace font
...
// Parse "thunderhot:" URI into recipient object, return true on successful parsing
