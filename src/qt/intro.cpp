...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("thunderhot Core"),
     ...
     * override -datadir in the thunderhot.conf file in the default data directory
     * (to be consistent with thunderhotd behavior)
     */
    if (dataDir != getDefaultDataDirectory())
