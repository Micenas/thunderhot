                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("thunderhot Wallet") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a thunderhot address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and thunderhot: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About thunderhot Core"), this);
    aboutAction->setStatusTip(tr("Show information about thunderhot Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for thunderhot"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your thunderhot addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified thunderhot addresses"));
    ...
    openAction->setStatusTip(tr("Open a thunderhot: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the thunderhot Core help message to get a list with possible thunderhot command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("thunderhot Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to thunderhot network", "", count));
}
...
{
    QString strTitle = tr("thunderhot Core"); // default title
