...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("thunderhot Core thunderhot-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  thunderhot-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded thunderhot transaction") + "\n" +
                               "  thunderhot-tx [options] -create [commands]   " + _("Create hex-encoded thunderhot transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded thunderhot transaction
