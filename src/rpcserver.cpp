...
Value stop(const Array& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop thunderhot server.");
    // Shutdown will take long enough that the response should get back
    StartShutdown();
    return "thunderhot server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* thunderhot features */
        {"thunderhot", "masternode", &masternode, true, true, false},
        {"thunderhot", "masternodelist", &masternodelist, true, true, false},
        {"thunderhot", "mnbudget", &mnbudget, true, true, false},
        {"thunderhot", "mnbudgetvoteraw", &mnbudgetvoteraw, true, true, false},
        {"thunderhot", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"thunderhot", "mnsync", &mnsync, true, true, false},
        {"thunderhot", "spork", &spork, true, true, false},
#ifdef ENABLE_WALLET
        {"thunderhot", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use thunderhotd, or the -server option to thunderhot-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> thunderhot-cli " + methodname + " " + args + "\n";
}
