...
This mechanism has been integrated into Bitcore-Node-thunderhot which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/thunderhot-Project/insight-api-thunderhot#web-socket-api](https://github.com/thunderhot-Project/insight-api-thunderhot#web-socket-api) 
* API: [https://github.com/thunderhot-Project/insight-api-thunderhot#swifttx-transactions](https://github.com/thunderhot-Project/insight-api-thunderhot#swifttx-transactions) 
...
By default, the thunderhot Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the thunderhot Core daemon:
