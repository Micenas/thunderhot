...
In order to support loading of multiple wallets in thunderhot-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is thunderhot.cpp.
...
Changes to thunderhot.cpp
----------------------
thunderhot.cpp is the entry point into thunderhot-qt, and as such, will require some minor modifications to provide hooks for
