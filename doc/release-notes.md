thunderhot Core version 2.3.0 is now available from:

  <https://github.com/thunderhot-project/thunderhot/releases>
...
Please report bugs using the issue tracker at github:
  ...
  <https://github.com/thunderhot-project/thunderhot/issues>

Compatibility
==============

thunderhot Core is extensively tested on multiple operating systems using
...
thunderhot Core should also work on most other Unix-like systems but is not
...
[
  {
    ...
    winner: {
        address: addr,    (string) thunderhot MN Address,
...
[
  {
    ...
    "addr": addr,      (string) Masternode thunderhot address
...
thunderhot Core now enables bloom filters by default to support SPV clients like mobile wallets. This feature can be disabled by using the `-peerbloomfilters` option on startup.
...
- #195 `aee05fe` [ZMQ] ZMQ integration for thunderhot (Mrs-X)
...
### Tests and QA
- #191 `3a778c3` [Tests] Fix the unit test suite for use with thunderhot (Fuzzbawls)
...
As well as everyone that helped translating on [Transifex](https://www.transifex.com/projects/p/thunderhot-project-translations/).
