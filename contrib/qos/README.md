...
This means one can have an always-on thunderhotd instance running, and another local thunderhotd/thunderhot-qt instance which connects to this node and receives blocks from it.
